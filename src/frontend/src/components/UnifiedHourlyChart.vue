<template>
  <div class="unified-hourly-chart">
...
import { isElementInViewport } from '@/utils/formatters'
...
const checkVisibility = () => {
  if (chartContainer.value) {
    isVisible.value = isElementInViewport(chartContainer.value)
  }
}
